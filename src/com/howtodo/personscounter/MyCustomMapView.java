...
public class MyCustomMapView extends MapView {
	...
	/*
	 * This method takes MotionEvents and decides whether or not a longpress
	 * has been detected. This is the meat of the OnLongpressListener.
	 * 
	...
	private void handleLongpress(final MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			longpressTimer.schedule(new TimerTask() {
				@Override
				public void run() {
					GeoPoint longpressLocation = getProjection().fromPixels((int) event.getX(), (int) event.getY() - 100);
					/*
